...
<div class="row">
    <div class="col-12">
        <div class="border py-3 px-md-5 px-2 mb-4">
            <h5 class="m-0">Menu / Dataset / Data Training</h5>
        </div>
    </div>
    ...
    <script>
        ...
        $('div.head-label').html(
            '<div>'+
                ...
                '<a href="{{ route("admin.training.export") }}" target="__blank" class="btn btn-primary me-2 border"><i class="fas fa-download me-2"></i>Export Data</a>'+
        ...
        function headData(){
            $.ajax({
                method: 'GET',
                url: '{{ route("admin.training.count") }}',
